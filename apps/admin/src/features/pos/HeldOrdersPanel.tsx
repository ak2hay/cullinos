import type { HeldOrder } from './heldOrdersStore';
  ...
  return (
    <>
      <button
        type="button"
        onClick={onToggle}
        className="relative rounded-xl border border-white/10 bg-bg-elevated px-3 py-2 text-sm font-medium transition hover:border-brand-primary/40"
      >
        Held
        {orders.length > 0 ? (
