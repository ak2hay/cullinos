...
export function GuestCouponsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold">Cullinos App coupons</h1>
        <p className="mt-1 max-w-2xl text-text-secondary">
          Create, edit, or remove offer codes across tenants for the Cullinos App. Used coupons
