...
function GroupForm({
  ...
  const testSmtpMutation = useMutation({
    mutationFn: superAdminApi.testSmtp,
  ...
  return (
    <form
      onSubmit={handleSave}
      className="space-y-4 rounded-xl border border-white/5 bg-bg-card p-6"
    >
        ...
        {group.id === 'msg91' ? (
          <>
            <input
              ...
              className="w-40 rounded-lg border border-white/10 bg-bg-elevated px-3 py-2 text-sm outline-none focus:border-brand-accent"
            />
            <button
              type="button"
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-text-secondary">
            Configure SMTP, storage, payments, phone OTP, and other API secrets.
