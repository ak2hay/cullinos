...
function SidebarNav({ onNavigate }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "border-b border-white/5 p-5", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-brand-primary font-mono font-bold text-bg-primary", children: "M" }), _jsxs("div", { children: [_jsx("p", { className: "font-semibold", children: CULLINOS_BRAND.name }), _jsx("p", { className: "text-xs text-text-muted", children: "Management" })] })] }) }), _jsx("nav", { className: "flex-1 space-y-1 overflow-y-auto p-3", children: navItems.map((item) => (_jsx(NavLink, { to: item.to, end: item.end, onClick: onNavigate, className: ({ isActive }) => `block rounded-lg px-3 py-2.5 text-sm transition ${isActive
...
export function AppShell() {
    ...
    return (_jsxs("div", { className: "flex min-h-screen bg-bg-primary", children: [_jsx("aside", { className: "hidden w-64 shrink-0 flex-col border-r border-white/5 bg-bg-secondary lg:flex", children: _jsx(SidebarNav, {}) }), mobileNavOpen ? (_jsxs("div", { className: "fixed inset-0 z-40 lg:hidden", children: [_jsx("button", { type: "button", "aria-label": "Close navigation", className: "absolute inset-0 bg-black/60", onClick: () => setMobileNavOpen(false) }), _jsx("aside", { className: "relative flex h-full w-[min(18rem,85vw)] flex-col border-r border-white/5 bg-bg-secondary shadow-xl", children: _jsx(SidebarNav, { onNavigate: () => setMobileNavOpen(false) }) })] })) : null, _jsxs("div", { className: "flex min-w-0 flex-1 flex-col", children: [_jsxs("header", { className: "flex min-h-16 flex-wrap items-center justify-between gap-4 border-b border-white/5 px-4 py-3 sm:px-6", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("button", { type: "button", "aria-label": "Open navigation", className: "rounded-lg border border-white/10 p-2 text-text-secondary lg:hidden", onClick: () => setMobileNavOpen(true), children: _jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: _jsx("path", { d: "M4 7h16M4 12h16M4 17h16", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round" }) }) }), _jsxs("div", { className: "flex flex-wrap items-end gap-4 sm:gap-6", children: [_jsxs("div", { children: [_jsx("p", { className: "text-xs text-text-muted", children: "Brand" }), _jsx(BrandSelector, {})] }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-text-muted", children: "Outlet" }), _jsx(OutletSelector, {})] })] })] }), _jsx("p", { className: "text-xs text-text-muted", children: "Enterprise console" })] }), _jsx("main", { className: "flex-1 overflow-auto p-4 sm:p-6", children: _jsx(Outlet, {}) })] })] }));
}
