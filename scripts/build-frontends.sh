...
export VITE_CUSTOMER_URL="${VITE_CUSTOMER_URL:-https://order.cullinos.com}"
...
echo "Building frontends with VITE_API_URL=$VITE_API_URL VITE_CUSTOMER_URL=$VITE_CUSTOMER_URL VITE_KDS_URL=$VITE_KDS_URL"
