...
const TEST_CASES = [
  ...
  // Phase 2.1
  { id: 'TC-2.1-01', phase: '2.1 Waiter', case: 'Employee login in Cullinos Waiter Android app', expected: 'Login succeeds' },
  ...
  // Phase 2.4
  { id: 'TC-2.4-01', phase: '2.4 Displays', case: 'Admin Displays (/displays) page loads', expected: 'Page loads' },
  { id: 'TC-2.4-02', phase: '2.4 Displays', case: 'CDS / Pickup / KDS / Promo URLs copyable and open', expected: 'Display loads' },
  { id: 'TC-2.4-03', phase: '2.4 Displays', case: 'Order appears in Preparing column on CDS/pickup', expected: 'Order in Preparing' },
  { id: 'TC-2.4-04', phase: '2.4 Displays', case: 'Order moves to Ready when marked', expected: 'Order in Ready' },
  { id: 'TC-2.4-05', phase: '2.4 Displays', case: 'Legacy /cds /kds /promo-display /pickup-queue redirect to /displays', expected: 'Redirect works' },
  // Phase 2.5
  ...
  // Phase 2.7
  { id: 'TC-2.7-01', phase: '2.7 Guest App', case: 'Deep link /o/{org}/{outlet} opens outlet', expected: 'Outlet opens' },
  { id: 'TC-2.7-02', phase: '2.7 Guest App', case: 'Phone OTP login succeeds (or Google/email)', expected: 'Auth succeeds' },
  { id: 'TC-2.7-03', phase: '2.7 Guest App', case: 'Home Discover loads restaurants', expected: 'Home loads' },
  { id: 'TC-2.7-04', phase: '2.7 Guest App', case: 'Explore filters work (Veg / Offers)', expected: 'Filters work' },
  { id: 'TC-2.7-05', phase: '2.7 Guest App', case: 'Offers tab loads', expected: 'Offers load' },
  { id: 'TC-2.7-06', phase: '2.7 Guest App', case: 'Scan QR opens outlet/session', expected: 'QR opens outlet' },
  { id: 'TC-2.7-07', phase: '2.7 Guest App', case: 'Profile loads when authenticated', expected: 'Profile loads' },
  { id: 'TC-2.7-08', phase: '2.7 Guest App', case: 'Orders list / detail load', expected: 'Orders load' },
  { id: 'TC-2.7-09', phase: '2.7 Guest App', case: 'Wallets / Coins pages load', expected: 'Loyalty pages load' },
  { id: 'TC-2.7-10', phase: '2.7 Guest App', case: 'Kiosk mode places pay-at-counter order', expected: 'Kiosk order placed' },
  // Phase 3
  ...
  { id: 'TC-3-10', phase: '3 Admin', case: 'Customers — create / search customer', expected: 'Customer created/found' },
  { id: 'TC-3-11', phase: '3 Admin', case: 'Coupons — create coupon on /coupons', expected: 'Coupon created' },
  ...
  { id: 'TC-3-16', phase: '3 Admin', case: 'Displays — CDS/Pickup URL opens with correct slugs', expected: 'URL correct' },
  ...
  { id: 'TC-3-20', phase: '3 Admin', case: 'Settings — Save settings (name / order types) persists', expected: 'Settings saved' },
  { id: 'TC-3-21', phase: '3 Admin', case: 'Settings — Add location / tax group / register device', expected: 'Location/tax/device OK' },
  ...
  { id: 'TC-3-25', phase: '3 Admin', case: 'Loyalty page — save settings / create tier or reward', expected: 'Loyalty updated' },
  { id: 'TC-3-26', phase: '3 Admin', case: 'Delivery — Add zone or list loads', expected: 'Delivery OK' },
  { id: 'TC-3-27', phase: '3 Admin', case: 'Marketplace listing — Save listing on /marketplace', expected: 'Listing saved' },
  { id: 'TC-3-28', phase: '3 Admin', case: 'Guest banners — Create banner on /guest-banners', expected: 'Banner created' },
  { id: 'TC-3-29', phase: '3 Admin', case: 'Billing page loads', expected: 'Page loads' },
  { id: 'TC-3-30', phase: '3 Admin', case: 'Displays — Kitchen KDS URL opens usable board', expected: 'KDS URL usable' },
  ...
  { id: 'TC-3-37', phase: '3 Admin', case: 'Payments — Razorpay/Cashfree tab Save (or N/A without keys)', expected: 'Saved or N/A' },
  { id: 'TC-3-38', phase: '3 Admin', case: 'Reservations — Create reservation + copy book link', expected: 'Reservation created' },
  { id: 'TC-3-39', phase: '3 Admin', case: 'Suppliers — Add supplier', expected: 'Supplier created' },
  { id: 'TC-3-40', phase: '3 Admin', case: 'Purchasing — Create draft PO', expected: 'PO draft created' },
  { id: 'TC-3-41', phase: '3 Admin', case: 'Central kitchen — page loads or N/A', expected: 'Loads or N/A' },
  { id: 'TC-3-42', phase: '3 Admin', case: 'Aggregators — Swiggy/Zomato tab loads; Connect or N/A', expected: 'Tabs OK or N/A' },
  { id: 'TC-3-43', phase: '3 Admin', case: 'SMS campaigns — page loads; Send or N/A if no wallet', expected: 'Page OK or N/A' },
  { id: 'TC-3-44', phase: '3 Admin', case: 'Menu — combos / schedules / outlet prices tab usable', expected: 'Tabs usable' },
  { id: 'TC-3-45', phase: '3 Admin', case: 'Reports — Export downloads for a tab', expected: 'Export works' },
  // Phase 4
  ...
  { id: 'TC-5-21', phase: '5 Super Admin', case: 'Guest Ops overview loads', expected: 'Overview loads' },
  { id: 'TC-5-22', phase: '5 Super Admin', case: 'Guest Ops marketplace — approve/rank QA listing', expected: 'Listing updated' },
  { id: 'TC-5-23', phase: '5 Super Admin', case: 'Guest Ops discover — create section', expected: 'Section created' },
  { id: 'TC-5-24', phase: '5 Super Admin', case: 'Guest Ops banners — create banner', expected: 'Banner created' },
  { id: 'TC-5-25', phase: '5 Super Admin', case: 'Guest Ops push — create draft', expected: 'Draft created' },
  { id: 'TC-5-26', phase: '5 Super Admin', case: 'Guest Ops offers — create offer', expected: 'Offer created' },
  { id: 'TC-5-27', phase: '5 Super Admin', case: 'Guest Ops reviews / users / analytics pages load', expected: 'Pages load' },
  { id: 'TC-5-28', phase: '5 Super Admin', case: 'Guest Ops runtime — Save runtime settings (safe toggle)', expected: 'Settings saved' },
  { id: 'TC-5-29', phase: '5 Super Admin', case: 'Promo Email — compose draft or send without crash (platform only)', expected: 'No crash' },
  { id: 'TC-5-30', phase: '5 Super Admin', case: 'Tenant detail — Open as tenant (impersonation) works', expected: 'Impersonation works' },
  // Phase 6
...
async function buildCredentialsLog() {
  ...
  const rows = [
    ...
    ['Waiter staff', 'Waiter app', 'Cullinos Waiter Android'],
...
async function main() {
  ...
  if (TEST_CASES.length !== 190) {
    console.warn(`Warning: expected 190 test cases, found ${TEST_CASES.length}`);
  }
